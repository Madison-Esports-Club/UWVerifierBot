...
bot.remove_command("help") #To have your own help command you have to remove the built-in discord one
###########################################################################     #Personally have become used to using 75 #s to seperate functions for readability
